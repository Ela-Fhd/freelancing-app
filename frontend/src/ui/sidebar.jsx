...
const CustomNavlink = ({ children, to }) => {
  const navlinkCls =
    "flex items-center gap-x-2 hover:text-primary-900 hover:bg-primary-100/50 rounded-lg px-2 py-1.5 transition duration-300";
  const navlinkActive = "bg-primary-100/50 text-primary-900";
